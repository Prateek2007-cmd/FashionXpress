...
async function main() {
  ...
  const categoryDefs = [
    { name: "All Sarees", slug: "all-sarees" },
    { name: "Kanchipuram Pattu Sarees", slug: "kanchipuram-pattu-sarees" },
    ...
    { name: "Banarasi Kathan Silk Sarees", slug: "banarasi-kathan-silk-sarees" },
    { name: "Crepe Silk Sarees", slug: "crepe-silk-sarees" },
    { name: "Work Sarees", slug: "work-sarees" },
    { name: "Ikkat Sarees", slug: "ikkat-sarees" },
    { name: "Kuppadam Sarees", slug: "kuppadam-sarees" },
    ...
    { name: "Chiniya Silk Sarees", slug: "chiniya-silk-sarees" },
    { name: "Khaddi Georgette Sarees", slug: "khaddi-georgette-sarees" },
    { name: "Semi Pattu Sarees", slug: "semi-pattu-sarees" },
