...
import { Package, LogOut, ClipboardList, Menu, X, Sun, Moon } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-black relative">
      ...
      <header className="h-16 border-b border-white/5 bg-card/50 flex items-center justify-between px-6 md:hidden z-40 w-full shrink-0">
        <div className="flex items-center gap-2">
          <img src="/logo.webp" alt="TFX Logo" className="h-7 w-auto object-contain" style={{ mixBlendMode: 'screen' }} />
      ...
      >
        <div className="h-20 flex items-center justify-between px-6 border-b border-white/5 shrink-0">
          <div className="flex items-center gap-2">
            <img src="/logo.webp" alt="TFX Logo" className="h-8 w-auto object-contain" style={{ mixBlendMode: 'screen' }} />
