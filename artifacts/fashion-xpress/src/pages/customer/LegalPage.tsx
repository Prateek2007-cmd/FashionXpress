    ...
    <div className="min-h-screen">
      <section className="relative overflow-hidden bg-gradient-to-b from-card/80 to-transparent border-b border-white/5 py-16 px-6">
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl font-serif font-black text-foreground mb-2">
      ...
      <section className="max-w-4xl mx-auto px-6 py-16 prose prose-invert max-w-none text-muted-foreground text-sm leading-relaxed space-y-8">
        {isPrivacy ? (
          <>
            ...
            <div className="bg-card/40 border border-white/5 rounded-2xl p-8 space-y-4">
              <h2 className="text-xl font-serif text-foreground">2. How We Use Your Data</h2>
              <p>
            ...
            <div className="bg-card/40 border border-white/5 rounded-2xl p-8 space-y-4">
              <h2 className="text-xl font-serif text-foreground">3. Doorstep Privacy & Safety</h2>
              <p>
            ...
            <div className="bg-card/40 border border-white/5 rounded-2xl p-8 space-y-4">
              <h2 className="text-xl font-serif text-foreground">4. Payment Security</h2>
              <p>
          ...
          <>
            <div className="bg-card/40 border border-white/5 rounded-2xl p-8 space-y-4">
              <h2 className="text-xl font-serif text-foreground">1. Home Visit & Trial Policy</h2>
              <p>
            ...
            <div className="bg-card/40 border border-white/5 rounded-2xl p-8 space-y-4">
              <h2 className="text-xl font-serif text-foreground">2. Product Authenticity & Pricing</h2>
              <p>
            ...
            <div className="bg-card/40 border border-white/5 rounded-2xl p-8 space-y-4">
              <h2 className="text-xl font-serif text-foreground">3. On-Spot Try & Selection Policy</h2>
              <p>
            ...
            <div className="bg-card/40 border border-white/5 rounded-2xl p-8 space-y-4">
              <h2 className="text-xl font-serif text-foreground">4. Service Availability</h2>
              <p>
